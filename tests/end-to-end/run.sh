...
curl -X PUT -H "x-api-token: secret" http://127.0.0.1:9101/register -d @example-001.json
curl -X PUT -H "x-api-token: secret" http://127.0.0.1:9101/register -d @example-002.json
